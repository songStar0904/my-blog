---
link: null
title: 深入理解javascript原型和闭包（14）——从【自由变量】到【作用域链】 - 王福朋 - 博客园
description: 先解释一下什么是“自由变量”。 在A作用域中使用的变量x，却没有在A作用域中声明（即在其他作用域中声明的），对于A作用域来说，x就是一个自由变量。如下图 如上程序中，在调用fn()函数时，函数体中第6
keywords: null
author: null
date: 2014-09-25T06:50:00.000Z
publisher: null
stats: paragraph=24 sentences=6, words=10
---
# 从【自由变量】到【作用域链】
...
我们拿文字总结一下取自由变量时的这个"作用域链"过程：（假设a是自由变量）
...
![](/my-blog/closure/251448515607115.png)
