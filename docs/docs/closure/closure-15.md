---
link: null
title: 深入理解javascript原型和闭包（15）——闭包 - 王福朋 - 博客园
description: 前面提到的上下文环境和作用域的知识，除了了解这些知识之外，还是理解闭包的基础。 至于“闭包”这个词的概念的文字描述，确实不好解释，我看过很多遍，但是现在还是记不住。 但是你只需要知道应用的两种情况即可
keywords: null
author: null
date: 2014-09-25T23:55:00.000Z
publisher: null
stats: paragraph=36 sentences=13, words=40
---
# 闭包
...
![](/my-blog/closure/260749156077205.png)

第一步，代码执行前生成全局上下文环境，并在执行时对其中的变量进行赋值。此时全局上下文环境是活动状态。

![](/my-blog/closure/260749349988764.png)

第二步，执行第17行代码时，调用fn()，产生fn()执行上下文环境，压栈，并设置为活动状态。

![](/my-blog/closure/260750319351092.png)
...
![](/my-blog/closure/260957500455644.png)

第四步，执行到第20行，执行f1(15)，即执行bar(15)，创建bar(15)上下文环境，并将其设置为活动状态。

![](/my-blog/closure/260958057327369.png)
